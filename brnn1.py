    ...
    for i, (names, countries) in enumerate(train_loader, 1):
        ...
        for name, param in classifier.named_parameters():
            if param.requires_grad:
                #print(name)
                if hasattr(name,'org'):
                    print("weight ooooooo ",name)
                                   
                    
        #for p in list(classifier.parameters()):
            #if hasattr(p,'org'):
                #print('@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@')
        ...
        for name, all_weights in classifier.named_parameters():
            ...
            if hasattr(all_weights,'org'):
                ...
                all_weights.copy_=all_weights.org
                #print("===============================",all_weights)
        ...
        for name, all_weights in classifier.named_parameters():
            ...
            if hasattr(all_weights,'org'):
                #print("???????????????????????????????",all_weights.org)
                all_weights.org.copy_(all_weights.clamp_(-1,1))
        """
